...
<head>
  ...
  <title>Bardhaman Online Shopping | Online Shopping Site for Men</title>
...
<body style="overflow-x:hidden; padding-bottom:100px;">
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/smzaptarshi@gmail.com" method="POST" name="_next">
